...
@Component({
  ...
  imports: [CommonModule, IonicModule, RouterModule,TareasComponent,EstimadorComponent, GraficaGanttComponent, AsignacionPersonalComponent,IncurridoTareasComponent],
})
